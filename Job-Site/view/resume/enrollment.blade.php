...
<div class="container" id="test">
	...
	<div class="col-md-offset-1 col-md-10">
	    <form onsubmit="return recodeCheck();" action="{{$mode == 'modify' ? 'resume/update?no='.$_GET['no'] : 'resume/store'}}" method="POST" name="form">
		...
		<select class="form-control" style="width:120px;height:60px;float:left;"  name="selectGrade">
		    ...
		    <option value="대학원">대학원</option>
                ...
                <div class="inputSchool" id="box5">
                    ...
                    <input value="{{$data['school']}}" style="outline:none;height:30px;width:105px;border: 0 none;" type="text" name="inputSchool" id="inputSchool">
                </div>
	    </div>
