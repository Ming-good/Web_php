...
<div class="container">
	...
	<div class="col-sm-offset-2 col-sm-8">
	    <h2>채용공고</h2>
        	<form name="form" action="<?php echo e($mode=='modify' ? 'list-g/modify?id='.$_GET['id'] : 'jobOpening/register'); ?>" method="post" encType="multipart/form-data" onsubmit = "return datasubmit();">
                <div class="form-group">
                    <input type="text" class="form-control" name="inputTitle" id="title" placeholder="타이틀을 입력해주세요." value="<?php echo e($listData['title']); ?>">
                </div>
			    ...
			    <tbody>
			       <tr>
				       ...
				       <select id='job1' class="form-control" value="IT정보통신"  name="category1" onchange="setCategory()">
				           ...
				           <option value="IT정보통신" <?php echo e($listData['job1']=="IT정보통신" ? 'selected' : ''); ?>>IT정보통신</option>
				           <option value="전문직,특수직" <?php echo e($listData['job1']=="전문직,특수직" ? 'selected' : ''); ?>>전문직,특수직</option>
				       </select>
			          </td>
			          <td>
			...
			<tr>
			    ...
			    <td>
                		...
                		<input type="radio" name="radioHire" id="radio-1" class="custom-control-input" <?php echo e($listData['hiring']=='계약직' ? 'checked' : ''); ?> value="계약직">
                		<label class="custom-control-label" for="radio-1">계약직&nbsp;&nbsp;&nbsp;</label>
                		<input type="radio" name="radioHire" id="radio-1" class="custom-control-input" <?php echo e($listData['hiring']=='인턴직' ? 'checked' : ''); ?> value="인턴직">
			    ...
			    <th style="width:80px;">기업형태:</th>
	    		    <td>
                		...
                		<input type="radio" name="radioShape" id="shape-2" class="custom-control-input" <?php echo e($listData['shape']=='중소기업' ? 'checked' : ''); ?> value="중소기업">
                		<label class="custom-control-label" for="shape-2">중소기업&nbsp;&nbsp;&nbsp;</label>
                		<input type="radio" name="radioShape" id="shape-3" class="custom-control-input" <?php echo e($listData['shape']=='벤처기업' ? 'checked' : ''); ?> value="벤처기업">
                		<label class="custom-control-label" for="shape-3">벤처기업</label>
                		<input type="radio" name="radioShape" id="shape-4" class="custom-control-input" <?php echo e($listData['shape']=='공기업' ? 'checked' : ''); ?> value="공기업">
                		<label class="custom-control-label" for="shape-4">공기업</label>
                		<input type="radio" name="radioShape" id="shape-5" class="custom-control-input" <?php echo e($listData['shape']=='기타' ? 'checked' : ''); ?> value="기타">
			...
			<tr>
			    ...
			    <td>
				       ...
				       <tr>
						   ...
						   <option value="면접후 결정" <?php echo e($listData['salary']== "면접후 결정" ? 'selected' : ''); ?>>면접후 결정</option>
                                                   <option value="시급" <?php echo e($listData['salary']=="시급" ? 'selected' : ''); ?>>시급</option>
                                                   <option value="일급" <?php echo e($listData['salary']=="일급" ? 'selected' : ''); ?>>일급</option>
                                                   <option value="주급" <?php echo e($listData['salary']=="주급" ? 'selected' : ''); ?>>주급</option>
                                                   <option value="월급" <?php echo e($listData['salary']=="월급" ? 'selected' : ''); ?>>월급</option>
                                               </select>
                                           </td>
				           <td>
					       <div><input value="<?php echo e($listData['money']); ?>" class="form-control" style="width:100px;" name="inputMoney" type="text"></div>
			...
			<tr>
			    ...
			    <td>
						...
						<option  value="">지역선택</option> 
                				<option  value="서울" <?php echo e($listData['area']=="서울" ? 'selected' : ''); ?>>서울</option> 
                				<option  value="경기" <?php echo e($listData['area']=="경기" ? 'selected' : ''); ?>>경기</option> 
                				<option  value="인천" <?php echo e($listData['area']=="인천" ? 'selected' : ''); ?>>인천</option> 
                				<option  value="부천" <?php echo e($listData['area']=="부천" ? 'selected' : ''); ?>>부천</option> 
                				<option  value="춘천" <?php echo e($listData['area']=="춘천" ? 'selected' : ''); ?>>춘천</option> 
                				<option  value="강원" <?php echo e($listData['area']=="강원" ? 'selected' : ''); ?>>강원</option> 
                				<option  value="부산" <?php echo e($listData['area']=="부산" ? 'selected' : ''); ?>>부산</option> 
                				<option  value="울산" <?php echo e($listData['area']=="울산" ? 'selected' : ''); ?>>울산</option> 
                				<option  value="경남" <?php echo e($listData['area']=="경남" ? 'selected' : ''); ?>>경남</option> 
                				<option  value="대구" <?php echo e($listData['area']=="대구" ? 'selected' : ''); ?>>대구</option> 
                				<option  value="경북" <?php echo e($listData['area']=="경북" ? 'selected' : ''); ?>>경북</option> 
                				<option  value="전주" <?php echo e($listData['area']=="전주" ? 'selected' : ''); ?>>전주</option> 
                				<option  value="전북" <?php echo e($listData['area']=="전북" ? 'selected' : ''); ?>>전북</option> 
                				<option  value="광주" <?php echo e($listData['area']=="광주" ? 'selected' : ''); ?>>광주</option> 
                				<option  value="전남" <?php echo e($listData['area']=="전남" ? 'selected' : ''); ?>>전남</option> 
                				<option  value="청주" <?php echo e($listData['area']=="청주" ? 'selected' : ''); ?>>청주</option> 
                				<option  value="충북" <?php echo e($listData['area']=="충북" ? 'selected' : ''); ?>>충북</option> 
                				<option  value="대전" <?php echo e($listData['area']=="대전" ? 'selected' : ''); ?>>대전</option> 
                				<option  value="충남" <?php echo e($listData['area']=="충남" ? 'selected' : ''); ?>>충남</option> 
                				<option  value="제주" <?php echo e($listData['area']=="제주" ? 'selected' : ''); ?>>제주</option> 
                                           </select>
                                       </td>
                                    </tr>
                                </tboty>
	        ...
	        <table class="table table-striped">
			    ...
			    <th>성별:</th>
	    		    <td>
                		...
                		<input type="radio" name="radioSex" id="sex-2" class="custom-control-input" value="여자" <?php echo e($listData['sex']=="여자" ? 'checked' : ''); ?>>
                		<label class="custom-control-label" for="sex-2">여자&nbsp;&nbsp;&nbsp;</label>
                		<input type="radio" name="radioSex" id="sex-3" class="custom-control-input" value="무관" <?php echo e($listData['sex']=="무관" ? 'checked' : ''); ?>>
			...
			<tr>
			    <th>경력사항:</th>
	    		    <td>
                		...
                		<input type="radio" name="radioCareer" id="career-3" class="custom-control-input" <?php echo e($listData['career']=="경력" ? 'checked' : ''); ?> value="경력">
                		<label class="custom-control-label" for="career-3">경력&nbsp;&nbsp;&nbsp;</label>
                		<input type="radio" name="radioCareer" id="career-1" class="custom-control-input" <?php echo e($listData['career']=="무관" ? 'checked' : ''); ?> value="무관">
		...
		<table class="table">
			...
			<tr>
				...
				<TEXTAREA style="display:none;"  name="comment" ROWS="5"><?php echo e($listData['comment']); ?></TEXTAREA>
...
function transform()
{
	...
	dhtmlframe.document.body.innerHTML = "<img id='image' src='/Job-Site/assets/upload/<?php echo e($listData['image']); ?>' style='max-width: 100%; height: auto;' alt=''/><br>"+strAll;
}
...
function select(){
	  ...
	  for(i = 0 ; i < length ; i ++){
		  if(document.getElementById("job2").options[i].value == "<?php echo e($listData['job2']); ?>"){
